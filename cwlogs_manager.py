...
if __name__ == '__main__':
    ...
    listing_logs=list_log_groups(region_name='ap-southeast-1')
    log.info(f'{listing_logs}')

    listing_streams = list_log_group_streams('/aws/lambda/logtest-ian', region_name='ap-southeast-1')
    log.info(f'{listing_streams}')
    
    filtering_events = filter_log_events('/aws/lambda/logtest-ian', 'START', start=start_ts, stop=end_ts,region_name='ap-southeast-1')
